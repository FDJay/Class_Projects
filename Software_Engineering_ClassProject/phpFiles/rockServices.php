...
<body style = "background-image: url('rock.jpeg');
...
<div class="page-header" align="center">
	...
	<h1 class="heading">Rock Genre Services</h1>
</div>	
<div align="right" >		
	     <?php
...
<body>	
	...
	<form id = "formid" role="form" action="rockServices.php" method="post">
	<table align="center" class="table table-striped" right = 30px border="2px"  style="width: 500px; line-height: 30px; background-color: #cecece; opacity: .9;">
		...
		<?php
		$sql = "SELECT user_id,service_name,class_difficulty_level,category_instrument_type,date_offered FROM teaching_services WHERE category_genre = 'Rock' AND offered = 1 ORDER BY date_offered"; 
