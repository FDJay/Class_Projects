...
<body style = "background-image: url('sPic.jpg');
...
<div class="page-header" align="center">
	...
	<h1 class="heading">Saxophone Services</h1>
</div>	
<div align="right" >		
	     <?php
...
<body>	
	...
	<form id = "formid" role="form" action="saxophoneServices.php" method="post">
	...
	<table align="center" class="table table-striped" left=70px border="2px"  style="width: 500px; line-height: 30px; background-color: #cecece; opacity: .9;">
		<tr>
			<th colspan = "3"><h2 align="center">Saxophone Teachers</h2></th>
		</tr>
