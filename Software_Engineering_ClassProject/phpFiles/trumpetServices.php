...
<body style = "background-image: url('trumpet.jpeg');
...
<div class="page-header" align="center">
	...
	<h1 class="heading">Trumpet Services</h1>
</div>	
<div align="right" >		
	     <?php
...
<body>	
	...
	<form id = "formid" role="form" action="trumpetServices.php" method="post">
	<table align="center" class="table table-striped" right = 30px border="2px"  style="width: 500px; line-height: 30px; background-color: #cecece; opacity: .9;">
		...
		<?php
		$sql = "SELECT user_id,service_name,class_difficulty_level,category_genre,date_offered FROM teaching_services WHERE service_name = 'Trumpet class' AND offered = 1"; 
	...
	<table align="center" class="table table-striped" left=70px border="2px"  style="width: 500px; line-height: 30px; background-color: #cecece; opacity: .9;">
		<tr>
			<th colspan = "3"><h2 align="center">Trumpet Teachers</h2></th>
		</tr>
