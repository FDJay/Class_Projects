...
<body style = "background-image: url('classicalPic.jpeg');
...
<div class="page-header" align="center">
	...
	<h1 class="heading">Classical Genre Services</h1>
</div>	
<div align="right" >		
	     <?php
...
<body>	
	...
	<form id = "formid" role="form" action="classicalServices.php" method="post">
	<table align="center" class="table table-striped" right = 30px border="2px"  style="width: 500px; line-height: 30px; background-color: #cecece; opacity: .9;">
		...
		<?php
		$sql = "SELECT user_id,service_name,class_difficulty_level,category_instrument_type,date_offered FROM teaching_services WHERE category_genre = 'Classical' AND offered = 1 ORDER BY service_name"; 
	...
	<table align="center" class="table table-striped" left=70px border="2px"  style="width: 500px; line-height: 30px; background-color: #cecece; opacity: .9;">
		<tr>
			<th colspan = "3"><h2 align="center">Teachers</h2></th>
		</tr>
